...
const translations = {
  es: {
    "brand.sub": "Terrenos y casas en venta y arrendamiento",
    "nav.about": "Nosotros",
    ...
    "hero.eyebrow": "Seguridad para tu inversión",
    ...
    "hero.stats.properties": "Oportunidades activas",
    "hero.stats.process": "Pago a la firma",
    "hero.stats.contact": "Atención directa",
    "hero.note": "El objetivo del sitio es proporcionar información clara con oportunidades reales en cuanto al precio y destino de tu inversión, con un enfoque profesional y un proceso de atención que te dé la mejor certeza legal y económica.",
    ...
    "about.title": "Información general",
    "about.lead": "El objetivo del sitio es proporcionar información clara con oportunidades reales en cuanto al precio y destino de tu inversión, con un enfoque profesional y con un proceso de atención que te dé la mejor certeza legal y económica.",
    "about.box1.title": "Por qué elegir OLA",
    "about.box1.text": "Nuestra prioridad es darte una atención eficaz y personalizada, cuidando en todo momento tus intereses como cliente para que puedas adquirir la mejor opción respecto a tu capacidad económica e intereses de inversión, cuidando en todo momento la privacidad de tus datos personales y económicos.",
    "about.box2.title": "Proceso de trabajo",
    "about.box2.text": "Entender tus necesidades y buscar la mejor opción, teniendo como primer momento la etapa de interés por algún inmueble para posteriormente pasar a una visita física y al final compartir la documentación jurídica que respalde la propiedad sujeta a inversión. Esto para mantener el interés real en la adquisición y seguridad jurídica de la transacción, dándote la seguridad y seriedad que respalden tu patrimonio.",
    "about.founderTitle": "Origen del proyecto",
    "about.founderText": "El proyecto nace de una visión clara respecto a la adquisición de bienes raíces con certeza jurídica e inversión justa, generando las condiciones correctas para el desarrollo de tu patrimonio, presentando de una manera transparente las opciones que se acerquen a tus posibilidades e interés para tu inversión y brindando una atención profesional que transmita confianza al momento de concretar la compra.",
    "approach.eyebrow": "Enfoque",
    "approach.title": "Una forma de trabajar más clara, más útil y más seria para ambas partes.",
    "approach.lead": "Buscamos identificar la mejor propiedad respecto a los intereses del cliente.",
    "approach.card1.title": "Filtrado inicial",
    "approach.card1.text": "El sitio presenta los inmuebles que se tienen listos para adquirir a las personas que consideren interés en dichos inmuebles.",
    "approach.card2.title": "Información en etapas",
    "approach.card2.text": "Proporcionamos ubicación y características del inmueble, así como su costo.",
    "approach.card3.title": "Seguimiento real",
    "approach.card3.text": "Visita física al inmueble.",
    ...
    "payment.title": "Pago únicamente al firmar la escritura",
    "payment.text": "Únicamente se paga a la firma de la escritura. Para seguridad del cliente, el pago se realiza una vez revisada la documentación por parte de su notario. Preferimos trabajar con notaría de tu confianza.",
  ...
  en: {
    "brand.sub": "Land and houses for sale and lease",
    "nav.about": "About",
    ...
    "hero.eyebrow": "Security for your investment",
    ...
    "hero.stats.properties": "Active opportunities",
    "hero.stats.process": "Payment at signing",
    "hero.stats.contact": "Direct attention",
    "hero.note": "The goal of the site is to provide clear information with real opportunities regarding the price and destination of your investment, with a professional approach and a process that gives you the best legal and economic certainty.",
    "hero.factArea": "Area",
    "hero.factZone": "Zone",
    ...
    "about.eyebrow": "About",
    "about.title": "General information",
    "about.lead": "The goal of the site is to provide clear information with real opportunities regarding the price and destination of your investment, with a professional approach and a process that gives you the best legal and economic certainty.",
    "about.box1.title": "Why choose OLA",
    "about.box1.text": "Our priority is to provide efficient and personalized attention, always protecting your interests so you can acquire the best option according to your economic capacity and investment interests, while also protecting the privacy of your personal and financial data.",
    "about.box2.title": "How the process works",
    "about.box2.text": "We understand your needs and look for the best option, starting with the stage of interest in a property, then moving to a physical visit and finally sharing the legal documentation that supports the property subject to investment. This helps maintain real interest in the acquisition and the legal security of the transaction, giving your assets the seriousness and backing they deserve.",
    "about.founderTitle": "Project origin",
    "about.founderText": "The project is born from a clear vision regarding the acquisition of real estate with legal certainty and fair investment, creating the right conditions for the development of your assets, transparently presenting options that match your possibilities and investment interest, and providing professional attention that builds confidence at the moment of purchase.",
    "approach.eyebrow": "Approach",
    "approach.title": "A clearer, more useful and more serious way of working for both sides.",
    "approach.lead": "We seek to identify the best property according to the client’s interests.",
    "approach.card1.title": "Initial filtering",
    "approach.card1.text": "The website presents the properties that are ready to be acquired to people who show interest in those properties.",
    "approach.card2.title": "Information by stages",
    "approach.card2.text": "We provide the location and characteristics of the property, as well as its cost.",
    "approach.card3.title": "Real follow-up",
    "approach.card3.text": "Physical visit to the property.",
    ...
    "payment.title": "Payment only upon signing the deed",
    "payment.text": "Payment is made only upon signing the deed. For the client’s safety, payment is made once the documentation has been reviewed by the client’s notary. We prefer to work with the notary of your choice.",
