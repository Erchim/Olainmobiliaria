...
const translations = {
  es: {
    ...
    "about.founderText": "El proyecto nace de una visión clara: los bienes raíces siguen siendo una de las formas más sólidas y seguras de construir y proteger el patrimonio. Después de una larga trayectoria profesional y de conocer distintos caminos, la decisión fue enfocarse en oportunidades inmobiliarias con una presentación más clara y un proceso más serio.",
    ...
    "payment.text": "Para seguridad del cliente, el pago se realiza únicamente al momento de la firma de la escritura, una vez revisada la documentación por parte del notario de su confianza. Preferimos trabajar con notaría de tu confianza.",
  ...
  en: {
    ...
    "about.founderText": "The project is built on a clear conviction: real estate remains one of the most solid and secure ways to build and protect long-term assets. After a long professional path and exposure to different directions, the decision was to focus on real estate opportunities with a clearer presentation and a more serious process.",
    ...
    "payment.text": "For the client’s safety, payment is made only at the moment of signing the deed, once the documentation has been reviewed by the client’s trusted notary. We prefer to work with the notary of your choice.",
