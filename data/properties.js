const propertyData = [
  {
    ...
    highlightsEs: ["Desarrollo privado con acceso controlado.", "Infraestructura urbana lista para una presentación más seria del inmueble.", "Conectividad atractiva para uso habitacional o inversión patrimonial."],
    highlightsEn: ["Private development with controlled access.", "Urban infrastructure ready for a more serious property presentation.", "Attractive connectivity for residential use or long-term investment."],
